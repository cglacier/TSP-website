...
import CityOverhead from "../Images/CityOverhead5.mp4";
import { ScrollTrigger } from "gsap/ScrollTrigger";
import businesstable from "../Images/businesstable.JPG"
import audience from "../Images/AGMaudience.JPG"
...
const Home = () => {
  ...
  return(
    <div ref={home} className='homepage'>
      ...
      <div className='about white_bg'>
        <img className='aboutimage' src={audience} />
        <h5 className='dark-blue'>Our Core Philosophy</h5>
        <hr className='separator dark-blue_bg'/>
        <p className='dark-blue'>
          At Teaspoon, we make activist investing easy.
          We believe anyone can possess unique insights and perspectives that can contribute to a better future.
          By harnessing the power of shareholder voting, we make it easy to actively engage with the decision-making processes of public companies, driving accountability, transparency, and responsible governance.
          Our role is to ensure your voice is heard and valued.
        </p>
      </div>
      ...
      <div className='panellong bgutil'>
        <div className='center'>
          <div className='box'>
