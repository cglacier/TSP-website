    ...
    <div className='process'>
      <div className='panel'>
        <div className='center'>
          <h2 className='dark-blue'>How do Shareholder's access their voting rights?</h2>
          <p className='dark-blue'>
            Learn about this process from Bob's story:
          </p>
          <hr className='separator dark-blue_bg'></hr>
      ...
      <div className='textbox'>
        <p className='dark-blue'>
          ...
          The first service we plan on providing will allow you, the stock owner, to change your status from OBO (Objectionary Beneficial Owner) to NOBO (Non-Objectionary Beneficial Owner) with the click of a button.
