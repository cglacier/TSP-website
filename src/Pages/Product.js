  ...
  return(
    <div ref={product} className='product'>
      <div className='center'>
        <h2 className='dark-blue'>What does Teaspoon do?</h2>
        <hr className='separator dark-blue_bg'/>
        <ul>
          <li><h6 className='dark-blue'>Provide an informational hub designed to keep activist investors informed</h6></li>
          <li><h6 className='dark-blue'>Build tools for shareholders so that activist investing is accessible to everyone</h6></li>
          <li><h6 className='dark-blue'>Connect activist investors with like-minded shareholders and the companies where they hold shares</h6></li>
          <li><h6 className='dark-blue'>Manage legal compliance for activist investors</h6></li>
        </ul>
      </div>
      ...
      <div className='formbox'>
        <p className='dark-blue'>Update me with product releases:</p>
        <Form/>
      </div>
      <Sitemap/>
    </div>
